    ...
    const recipes = [
        {
            ...
            image: "https://i.receptes.tvnet.lv/t/2022/03/03/34465/940x550.jpg"
        },
        {
            ...
            image: "https://i.receptes.tvnet.lv/t/2023/06/28/36298/940x550.jpg"
        },
        {
            ...
            image: "https://i.receptes.tvnet.lv/t/2026/01/08/38974/940x550.png"
        }
    ];
    
    let recipe = recipes[Math.floor(Math.random() * 3)];

// sii rindina dara pilniigi visu. 
document.getElementById("joks").innerHTML = "<h3>" + recipe.title + "</h3>" + "<p>" + recipe.text + "</p>" + "<a href='" + recipe.link + "'>" + recipe.link + "</a>" + "<img src='" + recipe.image + "' alt='" + recipe.title + "'>";
